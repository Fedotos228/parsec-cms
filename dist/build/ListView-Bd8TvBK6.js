import{k as h,a7 as m,e8 as y,j as e,e as x,T as f,h as ge,r as L,a as D,ah as S,b as oe,bc as q,bd as X,be as P,bf as Z,bi as _,bj as G,ae as Q,s as Y,D as N,bl as fe,aJ as se,I as ee,g as ie,bb as xe,cJ as be,aj as je,z as ye,ex as Ce,ai as we,fC as Te,c4 as te,fD as ve,E as ke,b5 as $e,B as ae}from"./strapi-B3p-d0cw.js";import{u as A,C as ne,g as u,a as re,A as Me}from"./index-LP48MKBN.js";import"./groupBy-CD-cp1l5.js";import"./_baseEach-DraHQupb.js";import"./index-D8RG5wa7.js";import"./index-BRVyLNfZ.js";import"./_arrayIncludesWith-BNzMLSv9.js";import"./sortBy-BzIdt8BR.js";import"./_baseMap-BxOnAUiU.js";const Ie=h(m)`
  table {
    width: 100%;
    white-space: nowrap;
  }
...
`,de=({customRowComponent:t,component:n,isFromDynamicZone:o=!1,isNestedInDZComponent:s=!1,firstLoopComponentUid:r})=>{const{modifiedData:i}=A(),{schema:{attributes:p}}=y(i,["components",n],{schema:{attributes:[]}});return e.jsx(le,{$isChildOfDynamicZone:o,className:"component-row",children:e.jsx("td",{colSpan:12,children:e.jsx(pe,{customRowComponent:t,items:p,targetUid:n,firstLoopComponentUid:r||n,editTarget:"components",isFromDynamicZone:o,isNestedInDZComponent:s,isSub:!0,secondLoopComponentUid:r?n:null})})})},Fe=({isActive:t=!1,icon:n="dashboard"})=>{const o=ne[n]||ne.dashboard;return e.jsx(x,{alignItems:"center",background:t?"primary200":"neutral200",justifyContent:"center",height:8,width:8,borderRadius:"50%",children:e.jsx(o,{height:"2rem",width:"2rem"})})},ce=h(m)`
  position: absolute;
  display: none;
  top: 5px;
  right: 0.8rem;
