const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["index-ZwBTm6Ty.js","strapi-DYO6Ziap.js","strapi-DU8PNWtk.css","index-DlupjiHK.js","index-ZaibqjYy.css"])))=>i.map(i=>d[i]);
import{r as d,bV as m,bW as N,_ as W}from"./strapi-DYO6Ziap.js";/**
 ...
 * @license Copyright (c) 2003-2025, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-licensing-options
 */const A=class V{constructor(e,n){f(this,"_lifecycle"),f(this,"_element"),f(this,"_releaseLock",null),f(this,"_value",null),f(this,"_afterMountCallbacks",[]),f(this,"_state",{destroyedBeforeInitialization:!1,mountingInProgress:null}),f(this,"release",H(()=>{const{_releaseLock:r,_state:o,_element:a,_lifecycle:i}=this;o.mountingInProgress?o.mountingInProgress.then(()=>i.unmount({element:a,mountResult:this.value})).catch(s=>{console.error("Semaphore unmounting error:",s)}).then(r.resolve).then(()=>{this._value=null}):(o.destroyedBeforeInitialization=!0,r.resolve())})),this._element=e,this._lifecycle=n,this._lock()}get value(){return this._value}unsafeSetValue(e){this._value=e,this._afterMountCallbacks.forEach(n=>n(e)),this._afterMountCallbacks=[]}runAfterMount(e){const{_value:n,_afterMountCallbacks:r}=this;n?e(n):r.push(e)}_lock(){const{_semaphores:e}=V,{_state:n,_element:r,_lifecycle:o}=this,a=e.get(r)||Promise.resolve(null),i=U();this._releaseLock=i;const s=a.then(()=>n.destroyedBeforeInitialization?Promise.resolve(void 0):(n.mountingInProgress=o.mount().then(c=>(c&&this.unsafeSetValue(c),c)),n.mountingInProgress)).then(async c=>{c&&o.afterMount&&await o.afterMount({element:r,mountResult:c})}).then(()=>i.promise).catch(c=>{console.error("Semaphore mounting error:",c)}).then(()=>{e.get(r)===s&&e.delete(r)});e.set(r,s)}};f(A,"_semaphores",new Map);let Ce=A;/**
 * @license Copyright (c) 2003-2025, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-licensing-options
 ...
 * @license Copyright (c) 2003-2025, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-licensing-options
 */function Ae(t){const e=JSON.stringify(t),n=Le(async()=>pe(t),[e]);return n.status==="success"?{...n.data,status:"success"}:n}const Ve=({attribute:t,name:e,disabled:n=!1,labelAction:r=null,required:o=!1,description:a=null,error:i=null,intlLabel:s})=>{d.useEffect(()=>()=>{const u=document.querySelectorAll('[data-injected-by="ckeditor-integration"]');document.querySelectorAll(".ck-editor__editable_inline ").length||u.forEach(p=>p.remove()),window.CKEDITOR_VERSION=null},[]);const c=Ae({version:"44.0.0",plugins:{CKEditorInput:async()=>(await W(async()=>{const{CKEditorInput:u}=await import("./index-ZwBTm6Ty.js");return{CKEditorInput:u}},__vite__mapDeps([0,1,2,3,4]))).CKEditorInput}});return c.status!=="success"?null:N.jsxDEV(c.loadedPlugins.CKEditorInput,{attribute:t,name:e,disabled:n,labelAction:r,required:o,description:a,error:i,intlLabel:s},void 0,!1,{fileName:"/Users/mac/Programing/Parsec/cms/node_modules/@ckeditor/strapi-plugin-ckeditor/admin/src/components/CKEditorProvider/index.jsx",lineNumber:47,columnNumber:5},void 0)},Me=d.memo(Ve),Be=Object.freeze(Object.defineProperty({__proto__:null,default:Me},Symbol.toStringTag,{value:"Module"}));export{Pe as C,ne as c,Be as i};
